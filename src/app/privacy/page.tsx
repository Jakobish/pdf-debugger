          ...
          <div className="grid gap-8">
            <section className="border rounded-lg p-6 bg-card">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-semibold m-0">Your Privacy is Protected</h2>
              </div>
              <p className="text-lg mb-4">
                PDF Debugger is designed with privacy as a core principle. We believe your documents 
                should remain private and secure.
              </p>
              <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                <p className="font-semibold text-green-800 dark:text-green-200 m-0">
                  🔒 Your PDF files never leave your device. Everything is processed locally in your browser.
                </p>
              </div>
            </section>
            ...
            <section className="border rounded-lg p-6 bg-card">
              ...
              <ul className="space-y-2">
                <li>✅ All PDF processing happens in your browser using WebAssembly</li>
            ...
            <section className="border rounded-lg p-6 bg-card">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-semibold m-0">Analytics & Tracking</h2>
              </div>
              <p>We use PostHog analytics to understand how our tool is used and improve the user experience:</p>
              <ul className="space-y-2 mt-4">
                <li><strong>What we collect:</strong> Page views, button clicks, and general usage patterns</li>
                <li><strong>What we DON'T collect:</strong> PDF content, file names, or any document data</li>
                <li><strong>Session recordings:</strong> PostHog may record user sessions for UX improvements</li>
                <li><strong>Your choice:</strong> You can disable analytics by using browser privacy tools</li>
              </ul>
            </section>
            ...
            <section className="border rounded-lg p-6 bg-card">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p>PDF Debugger uses Mozilla's PDF.js library compiled to WebAssembly to parse PDF files entirely within your browser. This means:</p>
                  <ul>
